...
import { resolveNavActiveSectionId } from '@/features/navigation/lib/sectionNavigation'
import { subscribeShowcaseCommittedStage } from '@/features/hero/lib/showcaseScroll'
