...
export function HeroIntroShell({ children }: { children: ReactNode }) {
  return (
    <div className="hero-intro-shell relative isolate flex h-svh min-h-svh w-screen max-w-[100vw] flex-col overflow-x-clip sm:h-dvh sm:min-h-dvh [margin-inline:calc(50%-50vw)] [margin-top:calc(-1*var(--site-header-total,4.5rem))]">
      <HeroIntroBeams />
